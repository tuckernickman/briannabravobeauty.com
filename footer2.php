  ...
  <div class="container pt-5 border-bottom">
    <div class="row">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="myservices.php">Services</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="Contact.php">Contact</a></li>
        </ul>
        </div>
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://www.facebook.com/bri.briannabeauty" target="_blank"><i class="fa fa-facebook mr-1"></i> Facebook</a>
          </li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://www.instagram.com/barefootbeautybybri/" target="_blank"><i class="fa fa-instagram mr-1"></i>Instagram</a>  
          </li>
        </ul>
        </div>
